...
(function() {
    ...
    const kinopoisk = function() {
        $(document).ready(function() {
            const $oldButton = $('button.kinopoisk-watch-online-button.styles_root__EZXGw.styles_rootPlus__bBjkI.styles_rootDesktop__fGTTz.styles_rootSizeH52__4QXvi.styles_isRounded__fiuxG.styles_watchOnlineButton__ruFtI');
            ...
            const $NameFilm = $('h1.styles_title___itJ6.styles_root__QSToS.styles_root__5sqsd.styles_rootInLight__juoEZ').children().first().text();
            GM.setValue('NameFilm', $NameFilm);
